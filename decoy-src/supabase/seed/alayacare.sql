...
begin
  ...
  insert into alayacare.client (client_id, salutation, first_name, last_name, birthday, zip, phone_main, ai_agent_opt_out, channels_of_communication, types_of_communication, notification_recipient, contacts, status, address_line, city, state) values
    ('C0100001', 'Mrs', 'Margaret', 'Voss', '1938-03-14', '3220', '+61411300001', '', 'Phone Call', '', 'Client', '[]', 'Active', '14 Ryrie St', 'Geelong', 'VIC'),
    ('C0100002', 'Mr', 'Harold', 'Fenwick', '1941-11-02', '3350', '+61411300002', '', 'Phone Call', '', 'Client', '[]', 'Active', '22 Sturt St', 'Ballarat', 'VIC'),
    ('C0100003', 'Mrs', 'Ivy', 'Castellano', '1933-07-19', '3199', '+61411300003', '', 'SMS', '', 'Family Contact', '[]', 'Active', '8 Beach St', 'Frankston', 'VIC'),
    ('C0100004', 'Mr', 'Desmond', 'Okafor', '1945-01-27', '3630', '+61411300004', '', 'Phone Call', '', 'Client', '[]', 'Active', '5 Wyndham St', 'Shepparton', 'VIC'),
    ('C0100005', 'Mrs', 'Lorna', 'Petrakis', '1937-09-08', '3550', '+61411300005', '', 'Email', '', 'Family Contact', '[]', 'Inactive', '31 Pall Mall', 'Bendigo', 'VIC');
